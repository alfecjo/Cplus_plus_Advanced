...
/**
 * Functor (função-objeto) que compara dois caracteres ignorando a diferença entre
 * maiúsculas e minúsculas usando `tolower`.
 */
struct Compare
{
...
int main()
{
    ...
    // v1 é um vector (vetor dinâmico).
    // l1 é uma list (lista duplamente encadeada).
    ...
    /**
     * Verifica se os elementos de v1 e l1 são iguais e na mesma ordem.
     * `equal` compara os elementos sequencialmente.
     */
    ...
    // 'J' ≠ 'j' → resultado será que os containers não são iguais.
